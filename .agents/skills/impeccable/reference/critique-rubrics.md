...
Load the relevant rubric when its assessment applies to the requested surface. Preserve the current brief and real evidence; examples are not findings about the target.
