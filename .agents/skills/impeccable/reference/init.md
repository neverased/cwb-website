...
Use the request and repository evidence to resolve these points. Ask only about material gaps that affect the outcome or scope; do not stop for settled facts or routine reversible choices.
...
- Use an available supported question tool or concise chat question only for material missing information; skip facts already supplied or established by the repository.
