...
2. Present distinct directions only when the brief leaves a material choice open. Explain browser support, performance, and complexity tradeoffs. Honor a direction or decision-making authority already supplied; otherwise wait for the specific user choice the work depends on.
